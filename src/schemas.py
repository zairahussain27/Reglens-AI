...
def sanitize_string(value: str) -> str:
    """Remove potentially malicious content from strings"""
...
class BusinessProfile(BaseModel):
    ...
    def validate_revenue(cls, v: str) -> str:
        ...
        # Validate revenue format: should contain numbers or currency terms
        if not re.search(r'\d+|crore|lakh|year|annual', v.lower()):
            raise ValueError('Revenue must contain valid currency information')
        return v
